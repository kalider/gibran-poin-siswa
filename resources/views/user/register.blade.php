...
<body>
    ...
    <main class="form-register w-100 m-auto">
        <form method="post" action="/register">
            ...
            <img class="mb-2" src="assets/logo/Poin.png" alt="" width="75" height="57">
                <h1 class="h4 mb-2 fw-normal">{{$title}}</h1>
            </div>
 ...
 @endif
            <p class="mt-2 mb-1 text-muted text-center">&copy; 2022 M Gibran Fajar</p>
        </form>
    </main>

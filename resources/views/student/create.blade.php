    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="bdayInput" placeholder="Tanggal lahir" name="bday" value="{{old('bday')}}">
            </div>
            <div class="mb-3">
                <label for="bplaceInput" class="form-label">Tempat lahir</label>
                <input type="text" class="form-control" id="bplaceInput" placeholder="Tempat lahir" name="bplace" value="{{old('bplace')}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="class_id" id="classIdSelect">
                    ...
                    @foreach ($classgroups as $item)
                        <option value="{{ $item->id }}" @selected(old('class_id') == $item->id)>{{ $item->class_name }}</option>
                    @endforeach
                </select>
            </div>
            <div>
